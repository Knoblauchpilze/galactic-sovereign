				...
				Resources: []models.Resource{
					{
						...
						StartProduction:               47,
						StartStorage:                  1055,
						BuildingBuildTimeHoursPerUnit: 36.256,
						ShipyardBuildTimeHoursPerUnit: 12.5,
				...
				Resources: []models.Resource{
					{
						...
						StartProduction:               15,
						StartStorage:                  1000,
						BuildingBuildTimeHoursPerUnit: 0.01478,
						ShipyardBuildTimeHoursPerUnit: 0.00739,
						CreatedAt:                     someOtherTime,
					},
				},
				Buildings: []models.Building{
				...
				Resources: []dtos.ResourceDtoResponse{
					{
						...
						BuildingBuildTimeHoursPerUnit: universes[0].Resources[0].BuildingBuildTimeHoursPerUnit,
						ShipyardBuildTimeHoursPerUnit: universes[0].Resources[0].ShipyardBuildTimeHoursPerUnit,
			...
			Planets: []dtos.SolarSystemPlanetDtoResponse{
				{
					...
					PlayerName: solarSystem.Planets[0].PlayerName,
				...
				},
				{
					...
					PlayerName: solarSystem.Planets[1].PlayerName,
