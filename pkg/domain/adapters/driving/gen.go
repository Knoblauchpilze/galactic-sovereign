...
//go:generate go run go.uber.org/mock/mockgen -source=../../app/ports/driving/for_creating_ship.go -destination=drivingportstest/create_ship_mocks.go -package=drivingportstest
