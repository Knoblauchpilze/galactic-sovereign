...
// Source: ../ports/driven/for_fetching_building.go
//
// Generated by this command:
//
//	mockgen -source=../ports/driven/for_fetching_building.go -destination=drivenportstest/buildings_mocks.go -package=drivenportstest
//
