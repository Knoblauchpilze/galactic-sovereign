...
//go:generate go run go.uber.org/mock/mockgen -source=../ports/driven/for_fetching_ship.go -destination=drivenportstest/ships_mocks.go -package=drivenportstest
//go:generate go run go.uber.org/mock/mockgen -source=../ports/driven/for_fetching_solar_system.go -destination=drivenportstest/solar_systems_mocks.go -package=drivenportstest
//go:generate go run go.uber.org/mock/mockgen -source=../ports/driven/for_listing_planets.go -destination=drivenportstest/planets_mocks.go -package=drivenportstest
