...
func TestPlanetBuildingDtoResponse_MarshalsToCamelCase(t *testing.T) {
	...
	assert.Nil(err)
	assert.Equal(`{"planet":"65801b9b-84e6-411d-805f-2eb89587c5a7","building":"461ba465-86e6-4234-94b8-fc8fab03fa74","level":37,"createdAt":"2024-05-05T20:50:18.651387237Z","updatedAt":"2024-07-28T10:30:02.651387236Z"}`, string(out))
}
